...
P7/P8 are quality-of-life and cheap. P9 rides on collision events (already in spec). P10/P11 are convention/helper additions. P12 needs `Tree.Reload(scene)` which is a whole framework concept.
