...
protected:
    ...
    ke_result SetupShader() override { return KE_OK; }
    ke_result SetupPostProcess() override { return KE_OK; }
    ke_result SetupSsao() override { return KE_OK; }
    ke_result SetupClustered() override { return KE_OK; }
    
    // Neutralize heavy frame logic that assumes real buffers
    void UpdateClusterBounds() override {}
    void DispatchLightCull() override {}
    ke_result SubmitSsao() override { return KE_OK; }
    ke_result SubmitPostProcess() override { return KE_OK; }
};
