...
public unsafe class RenderGraphTests
{
    ...
    private static ke_result MockAddPass(ke_render_graph* self, ke_render_pass_params* p, ke_error** out_error)
    {
        _addPassCalled++;
    ...
    {
        var native = BuildMockGraph();
        g_mockRemovePassResult = ke_result.KE_ERROR;
        var graph  = new RenderGraph(&native);
        try {
    ...
    [UnmanagedCallersOnly(CallConvs = [typeof(CallConvCdecl)])]
    private static ke_result MockRemovePass(ke_render_graph* self, sbyte* name, ke_error** out_error)
    {
        _removePassCalled++;
    ...
    [UnmanagedCallersOnly(CallConvs = [typeof(CallConvCdecl)])]
    private static ke_result MockCompile(ke_render_graph* self, ke_error** out_error) { _compileCalled++; return ke_result.KE_OK; }

    [UnmanagedCallersOnly(CallConvs = [typeof(CallConvCdecl)])]
    private static void MockDestroy(ke_render_graph* self) { }

    [UnmanagedCallersOnly(CallConvs = [typeof(CallConvCdecl)])]
    private static ke_result MockDeclareResource(ke_render_graph* self, ke_resource_desc* d, ke_error** out_error) => ke_result.KE_OK;

    [UnmanagedCallersOnly(CallConvs = [typeof(CallConvCdecl)])]
    private static ke_result MockImportTexture(ke_render_graph* self, sbyte* name, ke_texture_handle h, ke_error** out_error) => ke_result.KE_OK;

    [UnmanagedCallersOnly(CallConvs = [typeof(CallConvCdecl)])]
    private static ke_result MockExecute(ke_render_graph* self, ke_frame_packet* pkt, ke_error** out_error) => ke_result.KE_OK;
