...
var cube = render.UploadMesh(CubeMesh.Vertices, CubeMesh.Indices);
...
camC = new CameraComponent { Fov = 1.0f, NearPlane = 0.1f, FarPlane = 100.0f };
...
// Interleaved position + normal, unit cube centred at the origin.
static class CubeMesh
{
    public static readonly MeshVertex[] Vertices =
    {
        // +Z
        new(new(-0.5f,-0.5f, 0.5f), new(0,0, 1)), new(new( 0.5f,-0.5f, 0.5f), new(0,0, 1)),
        new(new( 0.5f, 0.5f, 0.5f), new(0,0, 1)), new(new(-0.5f, 0.5f, 0.5f), new(0,0, 1)),
        // -Z
        new(new( 0.5f,-0.5f,-0.5f), new(0,0,-1)), new(new(-0.5f,-0.5f,-0.5f), new(0,0,-1)),
        new(new(-0.5f, 0.5f,-0.5f), new(0,0,-1)), new(new( 0.5f, 0.5f,-0.5f), new(0,0,-1)),
        // +X
        new(new( 0.5f,-0.5f, 0.5f), new(1,0, 0)), new(new( 0.5f,-0.5f,-0.5f), new(1,0, 0)),
        new(new( 0.5f, 0.5f,-0.5f), new(1,0, 0)), new(new( 0.5f, 0.5f, 0.5f), new(1,0, 0)),
        // -X
        new(new(-0.5f,-0.5f,-0.5f), new(-1,0, 0)), new(new(-0.5f,-0.5f, 0.5f), new(-1,0, 0)),
        new(new(-0.5f, 0.5f, 0.5f), new(-1,0, 0)), new(new(-0.5f, 0.5f,-0.5f), new(-1,0, 0)),
        // +Y
        new(new(-0.5f, 0.5f, 0.5f), new(0,1, 0)), new(new( 0.5f, 0.5f, 0.5f), new(0,1, 0)),
        new(new( 0.5f, 0.5f,-0.5f), new(0,1, 0)), new(new(-0.5f, 0.5f,-0.5f), new(0,1, 0)),
        // -Y
        new(new(-0.5f,-0.5f,-0.5f), new(0,-1,0)), new(new( 0.5f,-0.5f,-0.5f), new(0,-1,0)),
        new(new( 0.5f,-0.5f, 0.5f), new(0,-1,0)), new(new(-0.5f,-0.5f, 0.5f), new(0,-1,0)),
