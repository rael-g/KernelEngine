...
app.OnReady = (resources) =>
{
    ...
    var right = app.ActiveWorld.Scene.AddNode(new MeshNode { MaterialHandle = matNormal }, "NormalQuad");
    ...
    var cam = app.ActiveWorld.Scene.AddNode(new CameraNode { Fov = 60f, Near = 0.1f, Far = 1000f }, "Camera");
