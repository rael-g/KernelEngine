...
// Build the ke_render_shadow shared library (Zig 0.16 API).
...
pub fn build(b: *std.Build) void {
    ...
    mod.addCMacro("KE_RENDER_SHADOW_EXPORT", "");

    // Matrix math for the light view-proj. The engine implements no math;
