...
// Build the ke_render_cluster shared library (Zig 0.16 API).
...
pub fn build(b: *std.Build) void {
    ...
    mod.addCMacro("KE_RENDER_CLUSTER_EXPORT", "");

    // Matrix math for the cull pass's camera/view transform. The engine
