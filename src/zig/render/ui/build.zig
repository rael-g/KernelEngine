...
// Build the ke_render_ui shared library (Zig 0.16 API).
...
pub fn build(b: *std.Build) void {
    ...
    inline for (.{ ke_common, ke_allocator, ke_ecs, ke_runtime, ke_render, ke_self }) |inc| {
    ...
    // Matrix math for the orthographic screen projection. The engine
