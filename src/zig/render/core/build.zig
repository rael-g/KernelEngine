...
pub fn build(b: *std.Build) void {
    ...
    inline for (.{ ke_common, ke_ecs, ke_runtime, ke_spatial, ke_render, ke_resource_cache, ke_logger, ke_self, ke_tonemap, ke_skybox, ke_ui, ke_gbuffer, ke_shadow, ke_cluster, ke_deferred_lighting, ke_forward }) |inc| {
