...
public unsafe partial struct ke_input_actions
{
    ...
    public delegate* unmanaged[Cdecl]<ke_input_actions*, int, ke_key, ke_error**, ke_result> bind_key;

    [NativeTypeName("ke_result (*)(struct ke_input_actions *, int32_t, ke_mouse_button, ke_error **)")]
    public delegate* unmanaged[Cdecl]<ke_input_actions*, int, ke_mouse_button, ke_error**, ke_result> bind_mouse_button;

    [NativeTypeName("ke_result (*)(struct ke_input_actions *, int32_t, ke_key, ke_key, ke_error **)")]
    public delegate* unmanaged[Cdecl]<ke_input_actions*, int, ke_key, ke_key, ke_error**, ke_result> bind_key_pair;

    [NativeTypeName("ke_result (*)(struct ke_input_actions *, int32_t, ke_key, ke_key, ke_key, ke_key, ke_error **)")]
    public delegate* unmanaged[Cdecl]<ke_input_actions*, int, ke_key, ke_key, ke_key, ke_key, ke_error**, ke_result> bind_key_quad;

    [NativeTypeName("ke_result (*)(struct ke_input_actions *, const ke_input_snapshot *, ke_input_action_event_func, void *, ke_error **)")]
    public delegate* unmanaged[Cdecl]<ke_input_actions*, ke_input_snapshot*, delegate* unmanaged[Cdecl]<void*, ke_input_action_event, void>, void*, ke_error**, ke_result> evaluate;
