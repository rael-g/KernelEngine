...
public unsafe partial struct ke_ecs
{
    ...
    [NativeTypeName("ke_result (*)(struct ke_ecs *, const char *, ke_component_meta *)")]
    public delegate* unmanaged[Cdecl]<ke_ecs*, sbyte*, ke_component_meta*, ke_result> component_lookup;
