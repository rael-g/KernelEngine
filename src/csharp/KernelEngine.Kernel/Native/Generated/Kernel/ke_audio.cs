...
public unsafe partial struct ke_audio
{
    ...
    public delegate* unmanaged[Cdecl]<ke_audio*, sbyte*, uint*, ke_result> load_sound;

    [NativeTypeName("void (*)(struct ke_audio *, ke_audio_sound)")]
    public delegate* unmanaged[Cdecl]<ke_audio*, uint, void> unload_sound;

    [NativeTypeName("ke_result (*)(struct ke_audio *, ke_audio_sound, float, ke_bool)")]
    public delegate* unmanaged[Cdecl]<ke_audio*, uint, float, byte, ke_result> play;
