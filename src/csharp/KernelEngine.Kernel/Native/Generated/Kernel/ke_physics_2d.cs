...
public unsafe partial struct ke_physics_2d
{
    ...
    public delegate* unmanaged[Cdecl]<ke_physics_2d*, ke_body_type_2d, float, float, uint*, int> create_body;
    ...
    public delegate* unmanaged[Cdecl]<ke_physics_2d*, uint, float, float, float, float, float, int> add_box_fixture;

    [NativeTypeName("ke_result (*)(struct ke_physics_2d *, ke_body_2d, float, float, float, float)")]
    public delegate* unmanaged[Cdecl]<ke_physics_2d*, uint, float, float, float, float, int> add_circle_fixture;
