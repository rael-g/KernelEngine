...
public unsafe partial struct ke_physics_2d
{
    ...
    [NativeTypeName("ke_result (*)(struct ke_physics_2d *, ke_body_type_2d, float, float, ke_body_2d *)")]
    public delegate* unmanaged[Cdecl]<ke_physics_2d*, ke_body_type_2d, float, float, uint*, ke_result> create_body;

    [NativeTypeName("void (*)(struct ke_physics_2d *, ke_body_2d)")]
    public delegate* unmanaged[Cdecl]<ke_physics_2d*, uint, void> destroy_body;

    [NativeTypeName("ke_result (*)(struct ke_physics_2d *, ke_body_2d, float, float, float, float, float)")]
    public delegate* unmanaged[Cdecl]<ke_physics_2d*, uint, float, float, float, float, float, ke_result> add_box_fixture;

    [NativeTypeName("ke_result (*)(struct ke_physics_2d *, ke_body_2d, float, float, float, float)")]
    public delegate* unmanaged[Cdecl]<ke_physics_2d*, uint, float, float, float, float, ke_result> add_circle_fixture;
