...
public unsafe partial struct ke_resource_cache
{
    ...
    public delegate* unmanaged[Cdecl]<ke_resource_cache*, uint, ke_result> register_resource;
    ...
    public delegate* unmanaged[Cdecl]<ke_resource_cache*, sbyte*, uint, ke_result> cache_insert;
