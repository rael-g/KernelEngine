...
public unsafe partial struct ke_asset_loader
{
    ...
    public delegate* unmanaged[Cdecl]<ke_asset_loader*, sbyte*, ke_model_data**, int> load_model;
    ...
    public delegate* unmanaged[Cdecl]<ke_asset_loader*, ke_task_scheduler*, sbyte*, delegate* unmanaged[Cdecl]<int, ke_model_data*, void*, void>, void*, ke_task*> load_model_async;
}
