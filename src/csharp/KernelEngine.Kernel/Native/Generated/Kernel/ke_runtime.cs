...
public unsafe partial struct ke_runtime
{
    ...
    public delegate* unmanaged[Cdecl]<ke_runtime*, ke_runtime_module_params*, ulong*, int> register_module;

    [NativeTypeName("ke_result (*)(ke_runtime *, const ke_runtime_system_params *, ke_system_id *)")]
    public delegate* unmanaged[Cdecl]<ke_runtime*, ke_runtime_system_params*, ulong*, int> register_system;

    [NativeTypeName("ke_result (*)(ke_runtime *, float)")]
    public delegate* unmanaged[Cdecl]<ke_runtime*, float, int> tick;
