...
public unsafe partial struct ke_shader_compiler
{
    ...
    public delegate* unmanaged[Cdecl]<ke_shader_compiler*, ke_result> on_initialize;

    [NativeTypeName("ke_result (*)(struct ke_shader_compiler *)")]
    public delegate* unmanaged[Cdecl]<ke_shader_compiler*, ke_result> on_shutdown;
    ...
    public delegate* unmanaged[Cdecl]<ke_shader_compiler*, sbyte*, sbyte*, sbyte*, sbyte*, sbyte*, sbyte**, nuint, ke_result> compile_shader;
}
