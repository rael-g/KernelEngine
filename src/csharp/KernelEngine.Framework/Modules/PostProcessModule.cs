...
/// <summary>
/// Opt-in post-process module — tonemapping, bloom, SSAO. Configure flags
/// either at construction (init properties) or by mutating the shared
/// <see cref="PostProcessState"/> singleton after Build at runtime. Without
/// this module the renderer's packet flags default to off and game code
/// would have to write them every frame manually.
/// </summary>
/// <remarks>
/// SSAO is currently broken in the bgfx backend (Kanban OBS.4/Z3); the flag
/// flows through here for symmetry but produces no visible effect until that
/// path is fixed. Bloom + tonemapping work.
/// </remarks>
