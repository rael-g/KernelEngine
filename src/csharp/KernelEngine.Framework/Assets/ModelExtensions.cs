...
/// </summary>
/// <remarks>
/// Hierarchy is flat for now — scene-graph parenting under a single root
/// node lands when Tree adds hierarchy. Game code that needs to move/scale
/// the model as a whole has to walk the returned nodes; once hierarchy is
/// in, the API gains a single parent node and the contract collapses to
/// "transform the root, the rest follows".
/// </remarks>
