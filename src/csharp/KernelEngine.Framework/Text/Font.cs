...
/// + an in-memory glyph table built from the CPU-side <see cref="FontData"/>
/// the loader produced. Game code creates one via <see cref="Load"/> from
/// inside a SceneModule callback and passes it to <see cref="Label"/> nodes.
/// </summary>
public sealed class Font : IDisposable
{
    ...
    /// render worker (i.e. from inside a SceneModule setup callback) because the
    /// texture upload is pinned there.
    /// </summary>
