...
/// applied to the measured text size — so <c>Anchor=(0.5, 0)</c> centers the
/// text horizontally with its top aligned to the anchor line, and
/// <c>Anchor=(1, 1)</c> bottom-right-aligns it.
/// </summary>
public class Label : Node
{
    ...
    /// <summary>Pixel offset applied AFTER anchor positioning. Useful for padding.</summary>
