...
public static unsafe partial class NativeMethods
{
    ...
    public static extern ke_result asset_resolver_create(ke_allocator* alloc, ke_image_loader* image_loader, ke_font_loader* font_loader, [NativeTypeName("const char *")] sbyte* project_root, ke_asset_resolver** @out);
}
