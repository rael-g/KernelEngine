...
/// <summary>
/// Per-frame: walks every <see cref="Label"/> registered with the tree and
/// emits one UI quad per glyph through the packet. Single-line layout only
/// (no wrapping / newlines). Pre-multiplies alpha so the UI shader's
/// <c>ONE/INV_SRC_ALPHA</c> blend composes correctly.
/// </summary>
