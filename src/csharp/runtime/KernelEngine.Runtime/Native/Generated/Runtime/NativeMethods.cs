...
public static unsafe partial class NativeMethods
{
    ...
    public static extern ke_result runtime_create([NativeTypeName("ke_ecs *")] KernelEngine.Ecs.Native.ke_ecs* ecs, [NativeTypeName("ke_scheduler *")] KernelEngine.Scheduler.Native.ke_scheduler* task_scheduler, [NativeTypeName("const ke_runtime_params *")] ke_runtime_params* @params, ke_runtime_handle* out_runtime, ke_error** out_error);
}
