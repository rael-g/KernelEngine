...
public unsafe partial struct ke_render_core
{
    ...
    [NativeTypeName("ke_material_handle (*)(struct ke_render_core *, const float *, float, float, ke_texture_handle, ke_error **)")]
    public delegate* unmanaged[Cdecl]<ke_render_core*, float*, float, float, ke_texture_handle, ke_error**, ke_material_handle> create_material;
