...
/// index buffers through an <see cref="IMeshUploader"/> and returns a handle.
...
public static class MeshPrimitives
{
    ...
    public static MeshHandle Cube(IMeshUploader uploader)
    {
        ...
        return uploader.UploadMesh(verts, idx);
    }
}
