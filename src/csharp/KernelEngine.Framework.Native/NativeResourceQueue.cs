...
internal sealed unsafe class NativeResourceQueue : IResourceCommandQueue, IDisposable
{
    ...
    public NativeResourceQueue(Allocator allocator)
    {
        ...
        KernelException.ThrowIfFailed(
            KernelEngine.Framework.Native.NativeMethods.resource_queue_create(allocator.Native, &p).ToManaged());
        _native = p;
    }
    ...
    public void Drain(IRenderer renderer)
    {
        ...
        var rendererNative = (KernelEngine.Framework.Native.ke_render*)r.Native;
        ...
        for (uint i = 0; i < drained; i++)
        {
            ...
            var rc = KernelEngine.Framework.Native.NativeMethods.resource_future_wait(f, uint.MaxValue);
            if (rc == ke_result.KE_OK)
            {
                uint handle = KernelEngine.Framework.Native.NativeMethods.resource_future_get_handle(f);
            ...
            KernelEngine.Framework.Native.NativeMethods.resource_future_release(f);
        }
    }
    ...
    public void Dispose()
    {
        if (_native is not null)
        {
            ...
            while (_pending.TryDequeue(out var entry))
            {
                ...
                KernelEngine.Framework.Native.NativeMethods.resource_future_release(
    ...
    private sealed class Factory : IResourceFactory, IAsyncResourceFactory
    {
        ...
        public Task<MeshHandle> CreateMeshAsync(Vertex[] vertices, ushort[] indices)
        {
            ...
            fixed (ushort *iptr = indices)
            {
                ...
                cmd.u.create_mesh.vertices     = (KernelEngine.Framework.Native.ke_vertex*)vptr;
                                                         ...
                                                         TextureHandle normalMap)
        {
            ...
            var m = new KernelEngine.Framework.Native.ke_material
            {
