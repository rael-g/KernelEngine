...
public static unsafe partial class NativeMethods
{
    ...
    public static extern ke_result scene_tree_create(ke_ecs* ecs, ke_scene_tree_handle* out_tree, ke_error** out_error);
    ...
    public static extern ke_result asset_resolver_create(ke_image_loader* image_loader, ke_font_loader* font_loader, [NativeTypeName("const char *")] sbyte* project_root, ke_asset_resolver_handle* @out, ke_error** out_error);
}
