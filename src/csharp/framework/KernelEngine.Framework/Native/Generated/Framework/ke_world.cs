...
public unsafe partial struct ke_world
{
    ...
    public delegate* unmanaged[Cdecl]<ke_world*, uint, delegate* unmanaged[Cdecl]<void*, KernelEngine.Ecs.Native.ke_variant_table_entry*, uint, void>, ke_error**, ke_result> register_component_apply;
