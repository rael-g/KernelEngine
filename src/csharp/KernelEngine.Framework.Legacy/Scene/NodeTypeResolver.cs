...
/// block. Three-step lookup: short name prefixed with <c>KernelEngine.Framework.Legacy</c>,
...
public static class NodeTypeResolver
{
    public static System.Type? Resolve(string typeName)
    {
        ...
        {
            var t = System.Type.GetType($"KernelEngine.Framework.Legacy.{typeName}, KernelEngine.Framework.Legacy");
