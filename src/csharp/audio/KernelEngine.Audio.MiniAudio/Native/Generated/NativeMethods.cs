...
public static unsafe partial class NativeMethods
{
    ...
    public static extern KernelEngine.Kernel.Native.ke_result audio_miniaudio_create([NativeTypeName("const ke_audio_miniaudio_params *")] ke_audio_miniaudio_params* @params, ke_audio_handle* @out, ke_error** out_error);
}
