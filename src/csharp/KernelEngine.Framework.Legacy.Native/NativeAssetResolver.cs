...
internal sealed unsafe class NativeAssetResolver : IAssetResolverBackend
{
                                ...
                                string? projectRoot)
    {
        ...
        var imgFw = (KernelEngine.Framework.Legacy.Native.ke_image_loader*)imageLoader;
        fixed (byte* rootPtr = rootBytes)
        {
            KernelException.ThrowIfFailed(
                KernelEngine.Framework.Legacy.Native.NativeMethods.asset_resolver_create(
    ...
    public TextureBuffer? ResolveTexture(string path)
    {
        ...
        KernelEngine.Framework.Legacy.Native.ke_texture_data* data;
        ke_result r;
        fixed (byte* p = bytes)
        {
...
// TextureBuffer and MaterialSpec records moved to KernelEngine.Framework.Legacy.Abstractions
