...
public sealed unsafe class Renderer : IRenderer
{
    ...
    {
        KernelThread.AssertCurrent("ke.render");
        return _native->set_orthographic(_native, enabled, null).Wrap();
    }
    ...
    {
        KernelThread.AssertCurrent("ke.render");
        return _native->set_ssao(_native, enabled, radius, bias, strength, null).Wrap();
    }
    ...
    {
        KernelThread.AssertCurrent("ke.render");
        return _native->set_tonemapping(_native, enabled, exposure, gamma, null).Wrap();
    }
    ...
    {
        KernelThread.AssertCurrent("ke.render");
        return _native->set_bloom(_native, enabled, threshold, intensity, null).Wrap();
    }
