#ifndef KERNEL_ENGINE_KERNEL_AUDIO_AUDIO_H_
#define KERNEL_ENGINE_KERNEL_AUDIO_AUDIO_H_
...
#define KE_AUDIO_SOUND_INVALID ((ke_audio_sound)0)
    ...
    typedef struct ke_audio
    {
        ...
        ke_result (*play)(struct ke_audio *self, ke_audio_sound sound, float volume, ke_bool loop);
...
#endif // KERNEL_ENGINE_KERNEL_AUDIO_AUDIO_H_
