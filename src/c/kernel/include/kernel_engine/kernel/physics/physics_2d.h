#ifndef KERNEL_ENGINE_KERNEL_PHYSICS_PHYSICS_2D_H_
#define KERNEL_ENGINE_KERNEL_PHYSICS_PHYSICS_2D_H_
...
#define KE_BODY_2D_INVALID ((ke_body_2d)0)
    ...
    typedef struct ke_physics_2d
    {
        ...
        ke_result (*create_body)(struct ke_physics_2d *self, ke_body_type_2d type, float x, float y, ke_body_2d *out);
...
#endif // KERNEL_ENGINE_KERNEL_PHYSICS_PHYSICS_2D_H_
