#ifndef KERNEL_ENGINE_CORE_MESSAGING_MESSAGE_PIPE_H_
#define KERNEL_ENGINE_CORE_MESSAGING_MESSAGE_PIPE_H_
...
#endif // KERNEL_ENGINE_CORE_MESSAGING_MESSAGE_PIPE_H_
